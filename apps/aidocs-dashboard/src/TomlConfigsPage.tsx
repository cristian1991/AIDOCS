          ...
          <div className="editor-panel">
            {selectedTomlDocument ? (
              <>
                ...
                />
                <button className="action-button" type="button" disabled={!selectedTomlDocument.editable || savingTomlPath === selectedTomlDocument.path || !configEditingAvailable()} onClick={handleTomlSave}>
