"""Everything-migrates-to-Rust contract harness (aidocs-doctrine §XXV).

One contract, many tongues. A §XXV contract test is DRIVER-PARAMETRIZED:
...
@dataclass
class Driver:
    """A named implementation of a seam under a §XXV contract test."""
...
def contract_drivers(
    ...
    *,
    ...
    """Drivers to parametrize a §XXV contract test over.
