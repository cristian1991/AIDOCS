...
IN_PROCESS_EGRESS_FINGERPRINTS: dict[str, dict[str, str]] = {
    "aidocs_service.py": {
        ...
        "rationale": "check-only version comparison against the release channel (Empire directive 2026-07-06); never fetches artifacts or installs — installs stay on signed/verified operator paths (aidocs-doctrine §XX); fail-soft on any network error",
    },
    "backend_models.py": {
