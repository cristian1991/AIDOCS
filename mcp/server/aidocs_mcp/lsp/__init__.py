"""aidocs_lsp — the DOOR (§XXVII "LSP joints law").
...
# A language server's fixed RAM floor (§XXVII). Below the configured
...
def lsp_drain_and_evict(
    ...
    *,
    ...
    Slice 2 (§XXVII "materialize the answers, evict the machine"): when
