...
# Dedicated PUSH capability for gate ai_git(op='push'). STRICTER than
# tier_m_edit (push needs both). Default-granted at issuance only to org
# owners/admins holding tier_m_edit; members only explicitly. Enforced
# fail-closed in outer_gate._oge_scope_admission AND in ai_git itself
# (git_push_authority.push_refusal).
