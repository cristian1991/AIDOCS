...
# the DB moves. Structural, not filtered (doctrine XII) — the same rule
...
# amendment 2 of 2026-07-30). Doctrine XIII: "Untrusted content ... is
...
def refuse_law_kind_from_public_door(kind: str) -> str | None:
    ...
    if normalized and normalized in exempt:
        return (
            ...
            "door: this is LAW, not a skill. aidocs-doctrine XIII — untrusted "
...
def refuse_lawbook_write_from_public_door(skill_id: str) -> str | None:
    ...
    return (
        ...
        "door: this row IS THE LAWBOOK, not a skill. aidocs-doctrine XIII — "
