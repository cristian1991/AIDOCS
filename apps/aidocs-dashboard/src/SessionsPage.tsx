...
export function SessionsPage({ sessions, sessionValue, onSelectSession, onDeleteSession, deletingSessionId, degradedState, onCreateSession, onConnectSession }: SessionsPageProps) {
