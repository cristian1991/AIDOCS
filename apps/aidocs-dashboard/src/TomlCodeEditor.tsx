  ...
  useEffect(() => {
    ...
    const state = EditorState.create({
      ...
      extensions: [
        ...
        darkTheme,
        // Read-only legacy/deprecated docs: the editor itself refuses
        // edits (belt to the disabled Save button).
    ...
    // Rebuild when read-only flips (e.g. switching to a legacy doc) so the
    // editable facet is applied; value is kept in sync by the effect below.
