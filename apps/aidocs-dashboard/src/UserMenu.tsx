  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        aria-haspopup="menu"
        aria-expanded={open}
        // The visible content is two INITIALS, so without this the button's
        // accessible name is "OP" — unreadable to a screen reader and
        // unfindable by anything looking for the signed-in identity. `title`
        // does not supply a name when the element has text content.
