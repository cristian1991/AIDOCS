...
class _ClosingConnection(sqlite3.Connection):
    ...
    Fixed at the ONE canonical connect (empire-doctrine VI) rather than at the
...
class SQLiteIndexStoreBase:
    ...
    # ONE canonical chokepoint (_sqlite_connect, doctrine VI) — the copy
    ...
    def connect(self, project_root: Path) -> sqlite3.Connection:
        ...
        # (this is the ONE canonical connect, empire-doctrine VI).
        ...
        # Doctrine VI — the pragma set is applied by the ONE chokepoint
