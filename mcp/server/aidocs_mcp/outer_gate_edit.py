...
# DURABILITY: AUDIT. edit_confirmations records that a single-use,
# content-bound confirmation was CONSUMED. That mark is what defeats
# replay of an approved edit, so losing the last one to a power cut
# does not lose runtime state -- it hands back a spent authorisation.
