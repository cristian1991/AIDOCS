...
class CodeIndexBundleService:
    ...
    def investigate(
        ...
        evidence lanes consult:
          ...
          * open backlog items matching the concept ("there is an open war
            about this");
        ...
        # 8. BACKLOG LANE — "there is an open war about this concept".
        try:
    ...
    def _backlog_lane(
        ...
        """Open backlog items whose title/tags resolve to the concept
        (bounded 3) — "there is an open war about this" is navigation gold.
        """
        ...
        for item in _bk.list_backlog(project_root, status="open", limit=200):
