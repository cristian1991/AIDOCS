...
class RuntimePresentationService:
    ...
    def dashboard_token_usage(
        ...
        _TOOL_CATEGORIES: dict[str, str] = {
            "code_find": "search", "code_search": "search", "code_text_search": "search",
            "code_investigate": "search", "code_trace": "search", "code_bundle": "search",
            "schema_query": "search", "code_find_dead_code": "search", "code_find_stale_references": "search",
            "code_get_lines": "read", "code_get_symbol_snippet": "read",
            "code_get_method_signature": "read", "code_get_method_signatures": "read",
            "code_get_service_api": "read", "code_get_enum_values": "read",
            "code_get_constructor_params": "read", "code_get_constructor_params_batch": "read",
            "code_get_entity_properties": "read", "code_get_dependencies": "read",
            "code_get_modules": "read", "code_get_module_files": "read",
            "code_edit_lines": "edit", "code_batch_edit": "edit",
            "code_str_replace": "edit", "code_batch_str_replace": "edit",
            "code_insert_lines": "edit", "code_create_file": "edit",
            "code_extract_block": "edit", "code_extract_symbol": "edit",
            "code_refactor_extract": "edit",
        }
        ...
        for tool_name, count in tool_counts.items():
            ...
            category_tokens[cat] = category_tokens.get(cat, 0) + tool_tok.get("tokens_in", 0) + tool_tok.get("tokens_out", 0)
        intent_breakdown = [
    ...
    def dashboard_snapshot(
        ...
        # Use explicit session_id for execution queries (not auto-resolved)
        # so "All Sessions" shows all events, not just the managed session's
        exec_session_filter = session_id  # None when user picks "All Sessions"
        ...
        *,
        ...
        try:
            ...
            conn.execute(
                ...
                (artifact_id, artifact_name, session_id, serialized, size_bytes,
    ...
    def read_result_artifact(
        ...
        try:
            ...
            row = conn.execute(
                "SELECT * FROM result_artifacts WHERE artifact_id = ?", (artifact_id,)
            ).fetchone()
            conn.close()
            if row is None:
                return None
