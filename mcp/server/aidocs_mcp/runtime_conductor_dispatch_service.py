...
class RuntimeConductorDispatchService:
        ...
        packet = SubagentTaskPacket(
            ...
            constraints=[
                *constraints,
                ...
                "Do NOT use raw bash/shell commands. Use AIDOCS MCP tools instead: ai_run (tests/builds/shell; detached, completion notify is universal — read via ai_run_output), ai_get_lines, ai_edit_lines.",
            ],
    ...
    def plan_conductor_status(
        ...
        return {**base, "lane_workers": lane_workers}
