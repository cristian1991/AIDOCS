...
class SkillStore:
    ...
    def empire_skill_read(
        ...
        *,
        ...
        per emperor-doctrine §X). Returns the row dict or None if missing.
        """
        import sqlite3
    ...
    def empire_skill_upsert(
        ...
        *,
        ...
        NLP grant per emperor-doctrine §X.
    ...
    def empire_soul_append(
        ...
        *,
        ...
        emperor-doctrine §X). Without authority, refuses on sovereign rows.
        ...
        try:
            ...
            if not sovereign_authority:
                raise PermissionError(
                    ...
                    f"grant per emperor-doctrine §X).",
                )
    ...
    # surface.
    #
    # Per emperor-doctrine §X grant grammar + §XVII operator-intent
    ...
    def list_skills(self, project_root: Path) -> list[dict[str, object]]:
        ...
        # priority 1) wins for empire-only skills (emperor-doctrine, scribe,
