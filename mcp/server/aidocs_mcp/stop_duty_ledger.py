...
# 5b #1075 blast completion: presents NEWLY owed blast surfaces once, to hosts
# whose Stop feedback reaches the agent. Lowest-priority blocker: any duty
# above that blocks defers it (the surfaces stay owed, unpresented).
DUTY_BLAST_COMPLETION = "blast_completion_presenter"
