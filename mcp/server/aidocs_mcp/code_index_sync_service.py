...
class CodeIndexSyncService:
    ...
    def sync_code_files(
        ...
        # ── #448 first production LSP joint (§XXXII guest oracle) ──
    ...
    def _lsp_joint_after_sync(self, project_root: Path, changed_paths: list[str]) -> None:
        ...
        that pass (bounded — never whole-tree). Guarded twice (§XXXII "a
        ...
        try:
            ...
            # §XXXII: an absent/broken guest costs zero function.
            return
    ...
    def replace_semantic_ref_edges(
        ...
        """Materialize LSP-derived ``semantic_ref`` edges (§XXXII guest oracle).
