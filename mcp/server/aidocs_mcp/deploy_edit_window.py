...
absent marker must NEVER fabricate a SAFE-TO-EDIT claim (empire-doctrine IV —
...
def deploy_failure_notice(
    ...
    *,
    ...
    (empire-doctrine IV, truth before green)."""
    if project_root is None:
        return None
    ...
    # provenance line is worse than a missing one (empire-doctrine IV, truth
