    ...
    *,
    ...
    try:
        hub.execution.record_event(
            project_root,
            event_kind="index_sitter_reconcile",
            source_kind="project_index_sitter",
            capability_name="index_sitter",
            action_kind="reconcile",
            target_entity=".MEMORY/.index",
            status="synced" if synced else "no_op",
