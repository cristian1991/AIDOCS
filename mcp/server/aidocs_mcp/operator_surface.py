...
_PROFILES: list[OperatorProfile] = [
    ...
    OperatorProfile(
        ...
        description=(
            "Distribution flavor (dev/solo/corpo) and the break-glass "
            "switches that relax governance: kill switch, "
            "dev-mode audit/RBAC bypass, and superadmin escape hatches. "
            "The most dangerous surface — flavor is global-locked."
        ),
...
def resolve_status(
    ...
    *,
    ...
    if prof.managed_by == "governed_bash":
        ...
        # SINGLE AUTHORITY (king re-seal 2026-05-30): live_execution_posture
...
def apply_profile(
    ...
    **service_params: Any,
    ...
    if prof.managed_by == "governed_bash":
        ...
        # THE one control (king re-seal 2026-05-30): "Allow shell tools
