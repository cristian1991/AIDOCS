...
capture and returns one of:
  ...
  NEEDS_USER_CLARIFICATION   — similar anchor + content overlap OR
                                ...
                                durable knowledge (king doctrine
                                2026-05-17).
...
def _auto_merge_enabled(project_root: Path) -> bool:
    ...
    user (king doctrine 2026-05-17 — humans curate). When the
...
def evaluate(
    ...
    *,
    ...
    Doctrine 2026-05-17 (king): when overlap is detected, the gate
    ...
    # Explicit supersede declaration ALWAYS wins (king doctrine — no
    # inference).
