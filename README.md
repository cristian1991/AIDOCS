...
This detects your agent hosts (Claude Code, Codex, OpenCode), configures MCP + hooks, and initializes your project. Run `aidocs doctor` to verify.

### Zero dependencies (Windows)

Download `AIDOCS-Setup.exe` from [Releases](https://github.com/cristian1991/AIDOCS/releases) — includes bundled Python, setup wizard, and dashboard. Double-click and follow the wizard.

### Zero dependencies (Linux/macOS)
