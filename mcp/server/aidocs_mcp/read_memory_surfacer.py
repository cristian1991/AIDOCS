...
Per king-doctrine §XI memory injection triggers, §XV evidence
...
# ---------------------------------------------------------------------------
# Tool name vocabulary (closed sets — king-doctrine §VI edit-tool ecology)
# ---------------------------------------------------------------------------
...
# king-doctrine §XI "memory injection triggers" / once-per-
        ...
        if granted and project_root is not None:
            ...
            if store is not None:
                ...
                for t in granted:
                    try:
                        if store.was_banner_shown(
                            project_root, cli_session_id=epoch, dnt_id=f"tool:{t}"
                        ):
                            continue
                    except Exception:
                        pass
