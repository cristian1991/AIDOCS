...
STATUS_BLESSED = "blessed"  # official wheel, fingerprint-matched
STATUS_CUSTOM = "custom"  # owned but not a clean official wheel
STATUS_DEV = "dev"  # editable / source tree — mutable
