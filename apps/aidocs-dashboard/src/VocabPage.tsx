  ...
  return (
    <section className="page page-config">
      <div className="page-fixed-header">
        ...
        <div style={{ display: "flex", gap: 12, alignItems: "center", padding: "8px 0 2px" }}>
          <label>
            Language:&nbsp;
          ...
          <button type="button" className="action-button" disabled={!configEditingAvailable()} onClick={startNewGroup} style={{ flex: "0 0 auto", width: "auto", whiteSpace: "nowrap" }}>
            + New group
          </button>
        </div>
        {kindMeta && <div style={{ color: "var(--text-faint)", fontSize: "0.8rem", padding: "0 0 8px" }}>{kindMeta.help}</div>}
      </div>
            ...
            {selectedGroupKey == null ? (
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                ...
                <div style={{ display: "flex", gap: 8 }}>
                  <button type="button" className="action-button" onClick={handleSave} disabled={busy || !configEditingAvailable()}>
                  ...
                  {selectedGroupKey !== NEW_GROUP_SENTINEL && (
                    <button
                      ...
                      disabled={busy || !configEditingAvailable()}
    ...
    <section className="page page-config">
      <div className="page-fixed-header">
        <div style={{ display: "flex", gap: 12, alignItems: "center", padding: "8px 0" }}>
          ...
          <button type="button" className="action-button" disabled={!configEditingAvailable()} onClick={startNew}>
            + New message
          </button>
