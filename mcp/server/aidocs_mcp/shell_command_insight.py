"""Shell parse-tree SECOND OPINION (#472 tranche; doctrine XXVII guest oracle).
...
substitutions, redirection targets, true argv boundaries. Per doctrine XXVII
...
(doctrine XXVI tree-sitter*), but the grammar binary is not present in every
