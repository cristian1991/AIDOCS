...
class RuntimeProjectSupportService:
    ...
    def project_structure_gaps(self, project_root: Path) -> list[str]:
        ...
        # required structure — durable memory is canonical in the sqlite
        # memory_index, never a .MEMORY/*.md default. Only the .aidocs routing
        # infra file remains a structural requirement.
        required = [
