...
# this we expect a multi-paragraph user message (Empire's eulogy case).
...
class NoPipelineAvailable(Exception):
    ...
    Empire doctrine 2026-05-12: no silent degradation via a regex
...
class AnalysisSource(str, Enum):
    ...
    AGENT_THOUGHT slot is reserved (Empire + co-co doctrine 2026-05-12):
...
class NLPService:
    ...
    def __init__(
        ...
        # Empire doctrine 2026-05-13: short bumped from 50ms to 200ms.
