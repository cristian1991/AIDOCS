...
class ProjectRegistryService:
    ...
    by the server startup step, never by a listing or a record (#1095).
    """
    ...
    def record_project(
        ...
        *,
        ...
        # The store enforces the AIDOCS marker guard at record() — pollution
        # from buggy subdir mkdirs never reaches the registry post-Beat-1+4.
        # #1095: schema only; the legacy-JSON ingest is a startup step
        # (known_projects_store.ensure_known_projects_store), not a call's.
    ...
    def list_projects(self) -> list[dict[str, Any]]:
        # #1095: a pure read -- no schema creation, no migration.
