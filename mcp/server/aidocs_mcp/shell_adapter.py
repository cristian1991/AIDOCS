...
Single authority for native shell tools:
  ...
  3. On EXECUTE_NATIVE there is NO read-only/pilot authorisation cage: AIDOCS
     ...
     unbounded follow). shell_pilot / shell_readonly / shell_family are
    ...
    *,
    ...
    try:
        ...
        if res.action == _enf.ACTION_EXECUTE_NATIVE:
            ...
            # FINAL canonical gate (king re-seal 2026-05-30): one freshly
            ...
            if receipted and live["ok"] and bound and native_capable:
                _record(
                    project_root,
                    host,
                    tool_name,
