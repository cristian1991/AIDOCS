...
export function SettingDetailPanel({
  ...
  // without leaving the slide-out (king feature 2026-05-03).
  ...
  return (
    <div className="flex h-full flex-col">
       ...
       * dead end. King reported being unable to toggle dev.kill_switch.
...
{draft !== undefined && draft !== asText(entry.scope_values?.[activeScope] ?? entry.default) && (
          ...
          {/* G/P/S scope toggle ABOVE the input (king directive 2026-05-03). */}
