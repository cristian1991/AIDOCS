...
import { getScope, hasStoredLogin, isWebBuild, loginWallSatisfied, onScopeChange, type Scope } from "./webmcpScope";
...
function App() {
  ...
  // Desktop cloud modes used to require a LIVE token here too, which re-walled
  // a signed-in operator on clicking "WebAgent" once the ~1h token aged out.
  const loginSatisfied = loginWallSatisfied();
