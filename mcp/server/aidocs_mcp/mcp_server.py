...
def create_server(dashboard_mode: bool = False, tools_profile: str = "full") -> Any:
    ...
    async def session_connect(
        ...
        if managed.get("active"):
            ...
            try:
                ...
                # #12 (king 2026-06-20): do NOT swallow silently — a sitter that
        ...
        try:
            ...
            # #12 (king 2026-06-20): do NOT swallow silently — a sitter that fails to
    ...
    async def ai_review(
        ...
        completion review. Per king-doctrine §VIII the conductor
