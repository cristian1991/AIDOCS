...
class PromptMutator:
    ...
    def apply_dnt_grants(
        ...
        *,
        ...
        try:
            ...
            # turn (doctrine XV — operator intent is present-tense).
    ...
    def notifications_drain(
        ...
        try:
            ...
            if managed_session_id and actor_id:
            ...
            elif not managed_session_id:
                # Managed session unresolved (e.g. a fresh CLI host with no
                # bound session) → peek-all fallback so notifications still
        ...
        try:
            if managed_session_id or host_session_id:
