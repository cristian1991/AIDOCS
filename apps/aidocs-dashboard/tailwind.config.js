...
export default {
  ...
  theme: {
    extend: {
      ...
      spacing: {
        // #471 three-step spacing doctrine. The ONLY sanctioned padding steps
        // for shell/page chrome (plus gap-2/gap-3 for gaps):
        //   pad-1 = 0.5rem  — compact controls        (equals p-2)
        //   pad-2 = 0.75rem — pills / cells           (equals p-3)
        //   pad-3 = 1rem    — panels / page headers   (equals p-4)
        // Ad-hoc paddings outside this scale are legacy; migrate on touch.
        "pad-1": "0.5rem",
        "pad-2": "0.75rem",
        "pad-3": "1rem",
      },
