...
export function UsagePage({ tokenEstimates, sessionBreakdown, eventRows, intentRows, onClearTokens, clearingTokens }: UsagePageProps) {
    ...
    <section className="page page-usage">
      <div className="usage-header">
        <div className="usage-token-summary">
          ...
          {onClearTokens && (
            <button type="button" className="action-button action-button-compact" disabled={clearingTokens || !configEditingAvailable()} onClick={onClearTokens} style={{ flex: "0 0 auto" }}>
