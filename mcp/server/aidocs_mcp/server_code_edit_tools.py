    ...
    *,
    ...
    def _check_batch_grounded(
        ...
        *,
        ...
        if not reasons:
            return None
        msg = f"{len(reasons)} edit target(s) not grounded — " + "; ".join(reasons)
        return edit_result(
            content_blocks=[
            ...
            structured={
                "ok": False,
                "error": msg,
                "blocked_by": "edit_not_grounded",
                "reason": "batch.edit_not_grounded",
            },
    ...
    def ai_get_lines(
        ...
        meta_bits: list[str] = [f"zone={structured['zone']}"]
