...
class ManagedModeService:
    ...
    def get_mode(
        ...
        *,
        ...
        Both `host_session_id` (canonical, agent_memory_epoch.py
        contract) and `cli_session_id` (deprecated alias) are accepted;
        host_session_id wins when both are passed. The kwarg alias
        survives one release for in-flight callers.
        ...
        sid = (host_session_id or cli_session_id or "").strip()
    ...
    def set_mode(
        ...
        *,
        ...
        state["requires_reconnect"] = False
        if cli_session_id:
            state["cli_session_id"] = cli_session_id
    ...
    def connect(
        ...
        *,
        ...
        """
        current = self.get_mode(project_root, cli_session_id=cli_session_id)
        ...
        return {
            ...
            "resolved_via": "per_conductor" if cli_session_id else "singleton_fallback",
        }
