...
# #755/#756: the ONE canonical connect. Both sites were
...
# This module's own docstring says 'both are read-only ... the audit
# surface, not the gate', so read_only=True makes that sqlite's rule
# rather than a docstring's claim.
                    ...
                    if job_lane:
                        ...
                        if not sid:
                            try:
                                ...
                                sid = resolve_managed_session(hub.managed_mode, root)
                            except Exception:
                                pass
