...
_DANGEROUS_CHAIN_PATTERNS: list[tuple[str, re.Pattern[str]]] = [
    ...
    # NOTE (#319/#233, empire-doctrine Article VI): command substitution
...
# ── #319/#233: narrowed command-substitution check (empire-doctrine VI) ────
#
...
def _evaluate_destructive_floor_decision(command: str, _depth: int = 0) -> dict[str, Any]:
    ...
    # gate, one segment model (empire-doctrine VI).
...
def _evaluate_bash_policy_decision(
    ...
    *,
    ...
    # on ai_run and the native core-law delegate (empire-doctrine VI).
    ...
    # policy path (native Bash hook) did not (empire-doctrine VI: one gate).
    ...
    # Phase 2c3 — parse-tree SECOND OPINION (doctrine XXVII guest oracle,
