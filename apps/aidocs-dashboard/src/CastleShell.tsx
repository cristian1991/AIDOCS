...
function CastleTopStrip({
  ...
  return (
    <div className="flex h-14 items-center gap-3 border-b border-castle-line bg-castle-panel/85 px-pad-3">
      <button
        type="button"
      ...
      {projectSelector ? (
        <div className="hidden min-w-0 shrink md:block">{projectSelector}</div>
      ) : (
        <div className="hidden min-w-0 max-w-[230px] shrink rounded-xl border border-castle-line bg-black/20 px-pad-2 py-pad-1 md:block" title={projectPath}>
      ...
      {sessionSelector ? (
        <div className="hidden min-w-0 shrink lg:block">{sessionSelector}</div>
      ) : (
        <div className="hidden min-w-0 max-w-[230px] shrink rounded-xl border border-castle-line bg-black/20 px-pad-2 py-pad-1 lg:block">
      ...
      {extras && <div className="flex shrink-0 items-center gap-2">{extras}</div>}
      <WebmcpModePanel />
      <button
        type="button"
        onClick={onRefresh}
...
export function CastlePageHeader({
  ...
  return (
    <div className="flex shrink-0 flex-nowrap items-center justify-between gap-3 border-b border-castle-line px-pad-3 py-pad-2">
      <div className="min-w-0">
        ...
        {subtitle && (
          <div className="mt-1 truncate text-sm text-castle-mute">{subtitle}</div>
        )}
      </div>
