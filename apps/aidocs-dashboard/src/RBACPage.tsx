 ...
 * Tauri command. The page surfaces what the Empire can see today;
      ...
      <div className="page-fixed-header rbac-header-row">
        ...
        <div className="config-header-actions">
            <button
              ...
              onClick={() => openUpgrade("webmcp-seats")}
              title="Invite teammates with RBAC roles - adds WebAgent seats"
            >
              + Invite teammates
            </button>
