...
# Truth label (#65, king 2026-06-20): git_fork_status / git_merge_plan compute
...
def register_legacy_git_tools(
    *,
    ...
    @renders_as("status", title="legacy runtime")
    def legacy_read_runtime() -> Any:
        """Inspect legacy NOW/plans state without mutating the project."""
        return hub.legacy.inspect_legacy(resolve_project_root())
