...
// Phoenix 2026-05-12: renamed from cerberus_* (king directive).
...
function ConductorChat({
  ...
  async function handleSend() {
    ...
    try {
      if (useMsg) {
        ...
        // msg substrate is async — replies surface via the king inbox poller.
        setAwaitingReply(false);
      } else {
  ...
  // King inbox poller — drains messages addressed to `king` every 5s
