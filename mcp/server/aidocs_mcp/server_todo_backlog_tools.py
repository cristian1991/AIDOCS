    ...
    *,
    ...
    def ai_backlog(
        ...
        add: requires active task (#82, 2026-05-10) — every backlog
             ...
             traceability. Defaults priority='normal' if omitted.
             Priority ladder (#101): critical > urgent > high > normal
             > low > idea ('medium' accepted as legacy alias of normal;
             urgent = operationally bleeding now, critical = halt other
             work — use sparingly).
