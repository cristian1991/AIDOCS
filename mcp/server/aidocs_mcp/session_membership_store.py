...
_MEMBERSHIP_SCHEMA_ENSURED = SchemaMemo()  # identity-validated (2026-07-09, schema_memo.py)
...
class SessionMembershipStore(SQLiteIndexStoreBase):
    def ensure_schema(self, project_root: Path) -> None:
        ...
        if _MEMBERSHIP_SCHEMA_ENSURED.is_current(db_path):
            return
        ...
        _MEMBERSHIP_SCHEMA_ENSURED.mark(db_path)
