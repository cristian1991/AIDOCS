...
def register_memory_index_tools(
    *,
    ...
    def code_get_module_files(
        module_path: str, modified_since: str | None = None, limit: int = 200, root: str = ""
    ) -> list[dict[str, Any]]:
        ...
        return hub.code.get_module_files(resolve_project_root(root), module_path=module_path, limit=limit, modified_since_ns=mtime_ns)
