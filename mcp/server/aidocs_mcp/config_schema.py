...
SETTINGS_CATALOG: dict[str, SettingMetadata] = {
    ...
    "conductor.task_routing": _setting(
        type="string",
        default="{}",
        description='JSON mapping task types to preferred backends. Example: {"refactor":"opencode/openai/gpt-4o","implement":"claude","design":"claude","test":"codex","docs":"opencode/google/gemini-2.5-pro","research":"opencode/xai/grok-3"}',
        scope=["user", "project"],
    ),
