...
export function OverviewPage({ snapshot, selectedSession, sessionBreakdown, intentRows, eventRows, contextBudget, compactingContext, onCompactContext }: OverviewPageProps) {
  ...
  const chartData = sessionData.length > 0 ? sessionData : toolData.length > 0 ? toolData : intentData;
